...
| Notes | *How are security events possible considering the risks the asset faces in its operating environment?* Security events are highly likely possible with likelihood and severity of exploitation is high , which disrupts business continuity and huge financial and data loss to the organization. A regular risk assessment might help organizations understand flaws in business operations and data storage and also compliance with security standards and regulations. |  |  |  |  |
